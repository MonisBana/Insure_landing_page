    ...
    <div className="w-full mt-48">
      <div className="container mx-auto">
        <div className="flex flex-col w-full flex-wrap ">
          <div className="bg-dark-violet w-32 h-0.5 opacity-20 mt-16 mx-auto lg:mx-0"></div>
          <p className="text-5xl lg:text-6xl text-center lg:text-left header-font mt-16">
            We’re different
          </p>
          <div className="mt-12 flex flex-col lg:flex-row lg:justify-between text-center lg:text-left">
            <div className="flex flex-col mt-4">
              ...
              <p className="opacity-80 mt-4 text-lg px-3 lg:px-0 lg:pr-24">
